...
namespace Is
{
    FlyweightSingletonManager *FlyweightSingletonManager::self_ = nullptr;

    recursive_mutex& FlyweightSingletonManager::getRecursiveMutex()
    {
        static recursive_mutex rmtx_{};
        return rmtx_;
    }

    FlyweightSingletonManager& FlyweightSingletonManager::getSelf()
    {
        ...
        if (!self_)
        {
            self_ = new FlyweightSingletonManager();
        }
        return *self_;
    }

    void FlyweightSingletonManager::eraseById(int id)
    {
    ...
    void FlyweightSingletonManager::clear()
    {
        FlyweightSingletonManager& self = getSelf();
